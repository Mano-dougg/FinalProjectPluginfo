...
//     <section className="pag-individual-produto">
//       <div className="individual-produto">
//         <Image className="individual-produto-img" src={ produto?.imagePath[indice]?.url ? `https://shine-original.s3.sa-east-1.amazonaws.com/${produto?.imagePath[indice]?.url}` : placeholder} width={736} height={477} alt="imagem do produto"/>
